export const bank_accounts_selectors = {
    ...
    ba_name_error: '#bankaccount-bankName-input-helper-text',
    routingNumber_error: '#bankaccount-routingNumber-input-helper-text',
    accountNumber_error: '#bankaccount-accountNumber-input-helper-text'
}